...
{
    public partial class frmVisaoPermissoes : Form
    {
        public frmVisaoPermissoes()
        {
            InitializeComponent();
            AtualizaGrid();
        }
        ...
        {
            string sql = "SELECT ID, NOME  FROM LUSUARIO";
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            frmCadastroPermissao frm = new frmCadastroPermissao(id);
            frm.ShowDialog();
            AtualizaGrid();
        }
